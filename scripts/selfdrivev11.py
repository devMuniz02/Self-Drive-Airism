...
if __name__ == "__main__":
    ...
    # --- THROTTLE MAXIMUM TRACKBAR ---
    # Create a trackbar for setting the maximum throttle (Auto Mode Base Throttle)
    # The value will be a percentage (0-100) that is converted to 0.0-1.0.
    # Initial value of 35 corresponds to the original BASE_THROTTLE = 0.35
    cv2.createTrackbar("**Throttle Max %**", CONTROLS_WINDOW, 35, 100, on_trackbar_change)
    ...
    # BASE_THROTTLE will be updated by the trackbar in the loop, 
    # but we keep the initial value for first iteration.
    BASE_THROTTLE_MAX_PERCENT = 35 
    BASE_THROTTLE_VALUE = BASE_THROTTLE_MAX_PERCENT / 100.0 # Initial value 0.35
    ...
    while True:
        try:
            ...
            # ... (ROI and Filter trackbars unchanged) ...
            ...
            # --- Get Throttle Max Slider Value and convert to [0.0, 1.0] ---
            throttle_max_percent = cv2.getTrackbarPos("**Throttle Max %**", CONTROLS_WINDOW)
            ...
            # --- AUTO MODE (No PID, pure angle steering) ---
                ...
                # --- Use the dynamic BASE_THROTTLE_VALUE from the trackbar ---
