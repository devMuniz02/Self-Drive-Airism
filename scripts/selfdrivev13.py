...
def draw_long_road_lines(base_image,
    ...
    1) Canny sobre la imagen HSV filtrada (limitado por ROI).
    ...
    5) Agrupa segmentos en conjuntos:
         - ángulo medio del grupo dentro de angle_merge_eps_deg
         - al menos un extremo a distancia <= endpoint_dist_thresh
       → Cada grupo corresponde a “una familia” de líneas.
    6) Para cada grupo:
